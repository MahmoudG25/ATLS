...
// Removed inline form controls and styles (moved to FormControls.jsx)
...
export default function DailyTaskForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // We extract the first operation's basic fields to satisfy the legacy container model requirements.
      // NOTE: This legacy data duplication is strictly for compatibility and will be removed in future phases.
