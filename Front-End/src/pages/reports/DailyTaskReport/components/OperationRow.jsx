        ...
        {isHrEnabled && (
          <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800/50">
            <Button
              ...
              className="w-full sm:w-auto h-auto py-2.5 px-4 whitespace-normal flex-wrap text-xs sm:text-sm text-center justify-center border-emerald-300 text-emerald-700 hover:bg-emerald-50 dark:border-emerald-800 dark:text-emerald-400 dark:hover:bg-emerald-950/30 flex items-center gap-2"
            >
                    ...
                    {laborEntries.map((entry, entryIdx) => {
                      ...
                      return (
                        <div
                          ...
                          className="grid grid-cols-12 gap-4 p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 shadow-sm relative items-start hover:border-emerald-200 dark:hover:border-emerald-900/50 transition-all duration-200 text-right animate-in fade-in-50 duration-200"
                        >
                          {/* حقل اسم العامل */}
                          <div className="col-span-12 md:col-span-3 flex flex-col items-start w-full">
                            ...
                            {isManual ? (
                              <Input
                                ...
                                className="h-10 text-xs w-full text-right border-slate-200 dark:border-slate-800 rounded-lg focus-visible:ring-emerald-500"
                              />
                            ) : (
                              <select
                          ...
                          <div className="col-span-6 sm:col-span-3 md:col-span-1 flex flex-col items-start w-full">
                            ...
                            <Input
                              ...
                              className="h-10 text-xs text-center font-bold w-full text-right border-slate-200 dark:border-slate-800 rounded-lg focus-visible:ring-emerald-500"
                            />
                          </div>
                          ...
                          <div className="col-span-6 sm:col-span-3 md:col-span-1 flex flex-col items-start w-full">
                            ...
                            <Input
                              ...
                              className="h-10 text-xs text-center font-bold text-red-600 dark:text-red-400 w-full text-right border-slate-200 dark:border-slate-800 rounded-lg focus-visible:ring-emerald-500"
                            />
                          </div>
                          ...
                          <div className="col-span-12 md:col-span-1 flex flex-col justify-end items-center w-full mt-4 md:mt-0">
                            <Button
                              ...
                              className="h-10 w-full text-red-500 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950/20 rounded-lg flex items-center justify-center border border-slate-200 dark:border-slate-800"
                            >
                  ...
                  <Field label="الإنتاجية (أساسي)">
                    <div className="flex flex-col gap-2">
                      <Input
                        ...
                        className={`h-10 ${getError('actual_productivity') ? 'border-red-500 bg-slate-100 dark:bg-slate-800' : (isFullEnclosure ? 'bg-slate-100 dark:bg-slate-800' : '')}`}
                      />
                ...
                render={({ field }) => (
                  <Field label="إنتاجية الإضافي">
                    <Input
                      ...
                      className={`h-10 ${getError('overtime_productivity') ? 'border-red-500' : ''}`}
                    />
                  </Field>
                )}
              />
