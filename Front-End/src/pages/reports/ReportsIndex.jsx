...
import { Box, Tabs, Tab, CircularProgress, Typography, Paper } from '@mui/material';
    ...
    <Box sx={{ width: '100%', p: { xs: 2, md: 4 } }}>
      <Box mb={4}>
        ...
        <Typography variant="subtitle1" color="text.secondary">
          {t('reports.module_subtitle', 'إدارة تقارير المهام اليومية، التسميد، الري، وتخصيص الحقول')}
        </Typography>
      </Box>
      ...
      <Paper elevation={0} sx={{ borderBottom: 1, borderColor: 'divider', mb: 4, borderRadius: 3, overflow: 'hidden', border: '1px solid #e2e8f0' }}>
        ...
        >
          ...
          <Tab icon={<SettingsIcon />} iconPosition="start" label={t('reports.tab_custom_fields', 'إعدادات الحقول المخصصة')} component={Link} to="/reports/custom-fields" />
        </Tabs>
      </Paper>
