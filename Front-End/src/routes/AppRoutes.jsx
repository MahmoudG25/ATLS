...
const AppRoutes = () => (
  <Suspense fallback={<PageLoader />}>
    <Routes>
      ...
      <Route path="/pending-approval" element={<ErrorBoundary><PendingApproval /></ErrorBoundary>} />
      <Route path="/403"              element={<ErrorBoundary><Forbidden403 /></ErrorBoundary>} />
      ...
      <Route path="/profile"    element={<ProtectedRoute><DashboardLayout><ErrorBoundary><UserProfile /></ErrorBoundary></DashboardLayout></ProtectedRoute>} />
      
      <Route path="/farm"       element={<ProtectedRoute requireModule="farm"><DashboardLayout><ErrorBoundary><FarmStructure /></ErrorBoundary></DashboardLayout></ProtectedRoute>} />
      <Route path="/palm"       element={<ProtectedRoute requireModule="palm"><DashboardLayout><ErrorBoundary><PalmRecords /></ErrorBoundary></DashboardLayout></ProtectedRoute>} />
      ...
      <Route path="/admin"      element={<ProtectedRoute requireRoles={['SUPER_ADMIN', 'OWNER', 'MANAGER']}><DashboardLayout><ErrorBoundary><AdminControls /></ErrorBoundary></DashboardLayout></ProtectedRoute>} />
      
      {/* 404 Fallback */}
      <Route path="*"           element={<ErrorBoundary><NotFound404 /></ErrorBoundary>} />
    </Routes>
  </Suspense>
);
