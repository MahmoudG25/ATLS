  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-3 rounded-xl shadow-lg">
        {label && <p className="text-gray-900 dark:text-gray-100 font-bold mb-1">{label}</p>}
...
export const AreaChartCard = ({ title, data = [], dataKey = 'value', color = '#16a34a', height = 280 }) => (
  <div className="bg-card text-card-foreground border border-gray-200 dark:border-gray-800 rounded-2xl p-5 shadow-sm">
