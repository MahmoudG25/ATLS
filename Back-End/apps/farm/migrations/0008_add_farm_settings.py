...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('farm', '0007_rename_farm_locati_company_aeab7b_idx_farm_locati_company_b69a3e_idx_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farm', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='settings', to='farm.farm')),
            ],
            options={
