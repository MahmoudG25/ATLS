...
from services.olive_service import list_olive_records, create_olive_record, update_olive_record
...
def olive_collection_view(request):
    if request.method == 'GET':
        ...
        return Response(OliveRecordSerializer(record).data, status=status.HTTP_201_CREATED)
